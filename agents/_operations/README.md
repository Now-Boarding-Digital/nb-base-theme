...
| [`client-quirks/`](client-quirks/) | Optional **`{client}.md`** for **one-client-only** constraints (not universal rules). Machine-readable Figma pointers live in [`../_config/clients/`](../_config/clients/). |
